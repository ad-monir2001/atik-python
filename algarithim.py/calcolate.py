...
font=('',30)
msg1=Label(text='Somantor',font=font,background='white',foreground='green',)
msg2=Label(text='SERIES',font=font,foreground='green',background='white')
msg1.grid(row=0,column=4)
msg2.grid(row=0,column=5)
